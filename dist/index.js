...
const buildEditor = ({
  ...
  plugins = [],
  enabledMenuOptions
}) => [...(plugins || []), prosemirrorHistory.history(), baseKeyMaps(schema), blocksInputRule(schema), textFormattingInputRules(schema), linksInputRules(schema), listInputRules(schema), prosemirrorDropcursor.dropCursor(), prosemirrorGapcursor.gapCursor(), Placeholder(placeholder), prosemirrorMenu.menuBar({
  floating: true,
